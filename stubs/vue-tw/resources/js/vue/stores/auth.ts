...
export const useAuthStore = defineStore("auth", {
    ...
    actions: {
        ...
        async updateProfile(data: { [key: string]: any }) {
            const { name, email, error } = data;
        ...
        async updatePassword(data: { [key: string]: any }) {
            const { current_password, password, password_confirmation, error } = data;

            error.value = {};

            const response = await axios.post("password-update", {
        ...
        async deleteAccount(data: { [key: string]: any }) {
            const { password, error } = data;

            error.value = {};

            const response = await axios.post("profile-delete", {
                password: password.value,
            })
