<template>
    <div class="position-relative">
        <div class="cs-d-sm-none py-4-cs top-navbar-box">
            <template v-if="authStore.user != null">
                <RouterLink :to="{ name: 'home' }" class="text-gray-cs navbar-navigation">Home</RouterLink>
            </template>
            <template v-else>
                <RouterLink :to="{ name: 'login' }" class="text-gray-cs navbar-navigation">Log in</RouterLink>
                <RouterLink :to="{ name: 'register' }" class="text-gray-cs navbar-navigation ml-3">Register</RouterLink>
            </template>
        </div>
                    ...
                    <div class="grid">
                        <div class="grid-card-box">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="cs-ms-3_1"><a href="https://laravel.com/docs"
                        ...
                        <div class="grid-card-box">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="cs-ms-3_1"><a href="https://laracasts.com"
                        ...
                        <div class="grid-card-box">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="cs-ms-3_1"><a href="https://laravel-news.com/"
...
if (document.querySelector('meta[name="laravel-version"]')) {
    const val = document.querySelector('meta[name="laravel-version"]').getAttribute("content");
...
if (document.querySelector('meta[name="php-version"]')) {
    const val = document.querySelector('meta[name="php-version"]').getAttribute("content");
...
@font-face {
    font-family: 'Nunito';
    src: url('https://fonts.bunny.net/css?family=Nunito');
}
...
.top-navbar-box {
    ...
    top: 0;
    right: 0;
    padding: 1.125rem 1.5rem 1.25rem 1.35rem;
    font-size: 0.875rem;
}
...
.grid-parent-box .grid .grid-card-box a {
    color: white;
    font-size: 1.125rem
}
...
.grid-card-box:nth-child(1) {
    border-left: none;
    border-top: none;
}

.grid-card-box:nth-child(2) {
    border-top: none;
    border-right: none;
}

.grid-card-box:nth-child(3) {
    border-bottom: none;
    border-left: none;
}

.grid-card-box:nth-child(4) {
    border-bottom: none;
    border-right: none;
}

.grid-card-box .ms-5 a,
.grid-card-box .ms-5 {
