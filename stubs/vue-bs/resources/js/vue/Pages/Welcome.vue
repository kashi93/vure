    ...
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            <template v-if="authStore.user != null">
                <RouterLink :to="{ name: 'home' }" class="text-sm text-gray-700 dark:text-gray-500 underline">Home</RouterLink>
            </template>
            <template v-else>
                <RouterLink :to="{ name: 'login' }" class="text-sm text-gray-700 dark:text-gray-500 underline">
                    Log in
                </RouterLink>
                <RouterLink :to="{ name: 'register' }" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">
                    Register
                </RouterLink>
            </template>
        </div>
