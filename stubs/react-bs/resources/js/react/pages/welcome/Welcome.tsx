...
export default function Welcome() {
  const css = new CssScope(styles);
  let laravelVersion = null;
  let phpVersion = null;
  const { user } = useAuthenticateContext();

  if (document.querySelector('meta[name="laravel-version"]') != null) {
    const val = document
      .querySelector('meta[name="laravel-version"]')
  ...
  if (document.querySelector('meta[name="php-version"]')) {
    const val = document
      .querySelector('meta[name="php-version"]')
      ?.getAttribute("content");
  ...
  return (
    <div className={css.scope("antialiased")}>
      <div
        className={css.scope(
      ...
      >
        <div
          className={css.scope("hidden fixed top-0 right-0 px-6 py-4 sm:block")}
        >
          {(() => {
            if (user != null) {
              return <Link
            ...
            return (
              <>
                ...
                <Link
                  to="/register"
                  className={css.scope(
                    "ml-4 text-sm text-gray-700 dark:text-gray-500 underline"
                  )}
                >
                  Register
                </Link>
        ...
        <div className={css.scope("max-w-6xl mx-auto sm:px-6 lg:px-8")}>
          <div
            className={css.scope(
          ...
          >
            <svg
              ...
              className={css.scope("h-16 w-auto text-gray-700 sm:h-20")}
            >
          ...
          >
            <div className={css.scope("grid grid-cols-1 md:grid-cols-2")}>
              <div className={css.scope("p-6")}>
                <div className={css.scope("flex items-center")}>
                  <svg
                    fill="none"
                    stroke="currentColor"
                    strokeLinecap="round"
                    ...
                    strokeWidth={2}
                    viewBox="0 0 24 24"
                    className={css.scope("w-8 h-8 text-gray-500")}
                  >
                ...
                <div className={css.scope("ml-12")}>
                  ...
                  >
                    ...
                    <a
                      ...
                      className={css.scope("underline text-gray-600 dark:text-gray-400 text-sm")}
                    >
          ...
          >
            <div
              className={css.scope(
                "text-center text-sm text-gray-500 sm:text-left"
              )}
            >
              <div className={css.scope("flex items-center")}>
                <svg
                  ...
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  className={css.scope("-mt-px w-5 h-5 text-gray-400")}
                >
                  <path d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
                <a
                  href="https://laravel.bigcartel.com"
                  className={css.scope("ml-1 underline text-sm text-gray-500")}
                >
                  Shop
                </a>
                <svg
                  ...
                  strokeWidth={2}
                  viewBox="0 0 24 24"
                  className={css.scope("ml-4 -mt-px w-5 h-5 text-gray-400")}
                >
