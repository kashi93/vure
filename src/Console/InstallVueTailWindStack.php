...
class InstallVueTailWindStack
{
    ...
    public function install(Command $command)
    {
        ...
        $command->info('Vure vue tailwind scaffolding installed successfully.');
    }
    ...
    {
        (new Filesystem)->copyDirectory(__DIR__ . '/../../stubs/vue-tw/resources', resource_path());
    }
